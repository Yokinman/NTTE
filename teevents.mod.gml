#define init
	...
	/*
		...
		2) Define scripts:
			...
			Event_goal	  : Returns a number by which the target number of floors generated by the base level is modified, leave undefined if base level size should remain unchanged
...
#define ScorpionCity_goal	 return 5/6;
...
#define SealPlaza_goal	  return 5/6;
		 ...
		 // Normal:
			...
			with(instance_create(0, 0, CustomObject)){
				...
				with(GenCont){
				 ...
				 // Goal Multiplier:
				if(mod_script_exists(mod_type, mod_name, event + "_goal")){
					var _goalMult = mod_script_call(mod_type, mod_name, event + "_goal");
					if(is_real(_goalMult)){
						with(instances_matching([GenCont, FloorMaker], "", null)){
							goal = ceil(goal * _goalMult);
						}
					}
				}
			}
